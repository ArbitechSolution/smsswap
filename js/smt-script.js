...
let abi =[{"constant":true,"inputs":[],"name":"rate","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_Rate","type":"uint256"}],"name":"setRate","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_busdAmount","type":"uint256"}],"name":"buyTokens","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"withDrawBUsd","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_Percentage","type":"uint256"}],"name":"setPercentage","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"_busdAmount","type":"uint256"}],"name":"_getTokenAmount","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"owner","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_amount","type":"uint256"}],"name":"withDrawSMS","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"percentage","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"inputs":[{"name":"_SMS","type":"address"},{"name":"_busd","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"constructor"},{"anonymous":false,"inputs":[{"indexed":true,"name":"from","type":"address"},{"indexed":true,"name":"to","type":"address"},{"indexed":false,"name":"value","type":"uint256"},{"indexed":false,"name":"time","type":"uint256"}],"name":"TransferBUSD","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"name":"owner","type":"address"},{"indexed":true,"name":"spender","type":"address"},{"indexed":false,"name":"value","type":"uint256"},{"indexed":false,"name":"time","type":"uint256"}],"name":"TransferSMT","type":"event"}]
  ...
  interval = setInterval(async function checkConnection() {
	try {
      let isConnected = false;
         ...
         $('.buy-details-danger .danger-message').text('Please install Dapp Browser first.');
	...
	try {
	    ...
	    else 
	    {
	      ...
	      // jQuery("#metamaskConnection").text(connection);
	      $('.buy-details-danger .danger-message').text('Please install Metamask first.');
         $('.buy-details-danger').removeClass('hidden');
	    }
	  } catch (error) {
...
async function setRate() {
  ...
  return new Promise(async (resolve, reject) => {
       contract.methods.setRate(amount).send({
         from:accounts[0]
  ...
  async function allowance() {
	  let tokencontract=new web3.eth.Contract(busdabi,busdcontractAddress);
		let amounttoken =await tokencontract.methods.allowance(accounts[0],contractAddress).call();
	  var appr = amounttoken/10**18;
	  if( ($('#getTokenAmount').val() != 0 || $('#getTokenAmount').val() != '') && $('#getTokenAmount').val() > appr)
	  {
	  	// buy now
    ...
    if(amount < 50)
	  {
		...
		let contract=new web3.eth.Contract(abi,contractAddress);
        contract.methods.buyTokens(amount).send({
        from:accounts[0]
        }).on("transactionHash", async (hash) => {
	        $('.buy-success .success-message').text('Successful! Transaction Hash: '+hash);
  ...
  let contract=new web3.eth.Contract(abi,contractAddress);
       contract.methods.setPercentage(amount).send({
         from:accounts[0]
       }).on("transactionHash", async (hash) => {
